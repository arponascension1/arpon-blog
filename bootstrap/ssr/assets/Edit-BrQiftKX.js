...
import { I as InputError, T as TextInput } from "./TextInput-9F-oIIhb.js";
...
function Edit({ category, parentCategories }) {
  ...
  return /* @__PURE__ */ jsxs(AdminLayout, { children: [
    /* @__PURE__ */ jsx(Head, { title: `Edit Category: ${category.name}` }),
    /* @__PURE__ */ jsx("div", { className: "py-6", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxs("div", { className: "mb-6 flex justify-between items-center", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "mt-1 text-sm text-gray-600", children: "Update category details and SEO settings" })
        ] }),
        /* @__PURE__ */ jsx(
          Link,
          {
      ...
      /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, className: "space-y-6", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "flex justify-end space-x-3", children: /* @__PURE__ */ jsx(PrimaryButton, { disabled: processing, children: "Update Category" }) })
      ] })
    ] }) })
  ] });
}
