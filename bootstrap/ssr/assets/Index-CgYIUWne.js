...
function Index({ tags, filters, sort }) {
  ...
  useEffect(() => {
    ...
    const timeoutId = setTimeout(() => {
      if (searchTerm === (filters.search || "") && currentSort.field === (sort?.field || "name") && currentSort.direction === (sort?.direction || "asc")) {
        return;
      }
      const params = {
  ...
  return /* @__PURE__ */ jsxs(AdminLayout, { children: [
    /* @__PURE__ */ jsx(Head, { title: "Manage Tags" }),
    /* @__PURE__ */ jsx("div", { className: "py-6", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxs("div", { className: "mb-8 flex justify-between items-center", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h1", { className: "text-2xl font-bold text-gray-900", children: "Tags" }),
          /* @__PURE__ */ jsx("p", { className: "mt-1 text-sm text-gray-600", children: "Label and organize your blog posts" })
        ] }),
      ...
      /* @__PURE__ */ jsx("div", { className: "bg-white shadow-sm rounded-lg mb-6", children: /* @__PURE__ */ jsx("div", { className: "px-4 py-5 sm:p-6", children: /* @__PURE__ */ jsx("div", { className: "flex flex-col sm:flex-row gap-4", children: /* @__PURE__ */ jsx("div", { className: "flex-1", children: /* @__PURE__ */ jsx(
        "input",
        {
          type: "text",
      ...
      /* @__PURE__ */ jsxs("div", { className: "bg-white shadow-sm rounded-lg", children: [
        /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "min-w-full divide-y divide-gray-200", children: [
          ...
          /* @__PURE__ */ jsx("tbody", { className: "bg-white divide-y divide-gray-200", children: tags.data.map((tag) => /* @__PURE__ */ jsxs("tr", { className: "hover:bg-gray-50", children: [
            /* @__PURE__ */ jsx("td", { className: "px-6 py-4 whitespace-nowrap", children: /* @__PURE__ */ jsx("div", { className: "text-sm font-medium text-gray-900", children: tag.name }) }),
            /* @__PURE__ */ jsx("td", { className: "px-6 py-4 whitespace-nowrap text-sm text-gray-500", children: tag.slug }),
            /* @__PURE__ */ jsx("td", { className: "px-6 py-4 whitespace-nowrap text-sm text-gray-500", children: new Date(tag.created_at).toLocaleDateString() }),
