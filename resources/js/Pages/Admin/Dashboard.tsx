                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                        <div className="lg:col-span-2 bg-white p-4 sm:p-6 rounded-2xl shadow-sm border border-gray-100">
                            <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 gap-y-2">
                                <div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                        ...
                        <div className="bg-white overflow-hidden shadow-sm rounded-2xl border border-gray-100">
                            <div className="px-4 py-5 sm:px-6 border-b border-gray-50 flex justify-between items-center bg-white">
                                <div>
                                    <h3 className="text-lg leading-6 font-bold text-gray-900">Popular Content</h3>
                        ...
                        <div className="bg-white overflow-hidden shadow-sm rounded-2xl border border-gray-100">
                            <div className="px-4 py-5 sm:px-6 border-b border-gray-50 flex justify-between items-center bg-white">
                                <div>
                                    <h3 className="text-lg leading-6 font-bold text-gray-900">Category Impact</h3>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                        ...
                        <div className="bg-white overflow-hidden shadow-sm rounded-2xl border border-gray-100">
                            <div className="px-4 py-5 sm:px-6 border-b border-gray-50 flex justify-between items-center bg-white">
                                <div>
                                    <h3 className="text-lg leading-6 font-bold text-gray-900">Recent Posts</h3>
                                            ...
                                            <div className="flex items-center justify-between gap-x-4">
                                                <div className="flex flex-col min-w-0">
                                                    ...
                                                    <div className="flex items-center mt-1">
                                                        <span className="text-xs text-gray-500 truncate max-w-[100px] sm:max-w-none">{post.author.name}</span>
                                                        <span className="mx-2 text-gray-300 shrink-0">•</span>
                                                        <span className="text-xs text-gray-500 truncate">{post.category?.name || 'Uncategorized'}</span>
                                                    </div>
                                                </div>
                                                <div className="flex items-center shrink-0">
                                                    <span className={`px-2 inline-flex text-[10px] leading-5 font-bold uppercase tracking-wider rounded-md ${
                                                        post.status === 'published' ? 'bg-green-50 text-green-700' : 'bg-yellow-50 text-yellow-700'
                                                    }`}>
                                                        {post.status}
                                                    </span>
                                                    <span className="ml-4 text-[10px] font-bold text-gray-400 uppercase hidden sm:block">
                        ...
                        <div className="bg-white overflow-hidden shadow-sm rounded-2xl border border-gray-100">
                            <div className="px-4 py-5 sm:px-6 border-b border-gray-50 flex justify-between items-center bg-white">
                                <div>
                                    <h3 className="text-lg leading-6 font-bold text-gray-900">Recent Users</h3>
                                        ...
                                        <li key={user.id} className="px-4 py-4 sm:px-6 hover:bg-gray-50 transition-colors">
                                            <div className="flex items-center justify-between">
                                                <div className="flex items-center min-w-0">
                                                    <div className="flex-shrink-0 h-10 w-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-500 border border-gray-50">
                                                ...
                                                <div className="flex flex-col items-end shrink-0">
                                                    {user.is_admin ? (
                                                        <span className="px-2 inline-flex text-[10px] font-black uppercase tracking-widest rounded-md bg-purple-50 text-purple-700 mb-1">
                                                            Admin
                                                        </span>
                                                    ) : (
                                                        <span className="px-2 inline-flex text-[10px] font-black uppercase tracking-widest rounded-md bg-gray-50 text-gray-700 mb-1">
                                                            User
                                                        </span>
                                                    )}
                                                    <span className="text-[10px] text-gray-400 font-bold hidden sm:block">
                    ...
                    <div className="bg-white overflow-hidden shadow-sm rounded-2xl border border-gray-100 mb-8">
                        <div className="px-4 py-5 sm:px-6 border-b border-gray-50 bg-white flex justify-between items-center">
                            <div>
                                <h3 className="text-lg leading-6 font-bold text-gray-900">Platform Activity</h3>
                            ...
                            {recent_activity.length > 0 ? (
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                                    {recent_activity.map((activity) => (
                                        <div key={activity.id} className="flex items-start space-x-4 p-4 rounded-2xl bg-gray-50 border border-gray-50 hover:bg-white hover:shadow-md transition-all group">
                                ...
                                <div className="py-12 text-center">
                                    ...
                                    <p className="text-gray-500 italic">Waiting for interactions...</p>
                                </div>
                            )}
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        <div className="lg:col-span-2 bg-white overflow-hidden shadow-sm rounded-2xl border border-gray-100">
                            <div className="px-4 py-5 sm:px-6 border-b border-gray-50 bg-white">
                                <h3 className="text-lg leading-6 font-bold text-gray-900">Quick Actions</h3>
                            </div>
                            <div className="p-4 sm:p-6">
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    ...
                                    >
                                        <div className="p-3 bg-blue-600 rounded-xl text-white mr-4 shadow-sm">
                                            <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    >
                                        <div className="p-3 bg-purple-600 rounded-xl text-white mr-4 shadow-sm">
                                            <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    >
                                        <div className="p-3 bg-green-600 rounded-xl text-white mr-4 shadow-sm">
                                            <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    >
                                        <div className="p-3 bg-orange-600 rounded-xl text-white mr-4 shadow-sm">
                                            <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div className="bg-white overflow-hidden shadow-sm rounded-2xl border border-gray-100">
                            <div className="px-4 py-5 sm:px-6 border-b border-gray-50 bg-white">
                                <h3 className="text-lg leading-6 font-bold text-gray-900">System</h3>
                            </div>
                            <div className="p-6">
                                <div className="space-y-4">
                                    <div className="flex items-center justify-between">
                                        <span className="text-sm text-gray-500 font-medium">Server</span>
                                        <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-[10px] font-black uppercase tracking-widest bg-green-50 text-green-700">
                                            Online
                                        </span>
                                    </div>
                                    <div className="flex items-center justify-between">
...
function StatCard({ title, value, description, icon, colorClass }: StatCardProps) {
    return (
        <div className="bg-white overflow-hidden shadow-sm rounded-2xl border border-gray-100 hover:shadow-md transition-all duration-300">
            <div className="p-5">
                <div className="flex items-center">
                    <div className={`flex-shrink-0 ${colorClass} rounded-xl p-3 shadow-sm`}>
                        {icon}
                    </div>
                    <div className="ml-5 w-0 flex-1">
                        <dl>
                            <dt className="text-[10px] font-black text-gray-400 uppercase tracking-widest truncate">
                                {title}
                            </dt>
