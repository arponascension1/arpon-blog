...
export default function Edit({ post: initialPost, categories, tags }: EditProps) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        tags: initialPost.tags?.map(t => t.id) || [] as number[],
    ...
    return (
        <AdminLayout>
            <Head title={`Edit Post: ${initialPost.title}`} />
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="flex justify-between items-center">
                            <div>
                                <h1 className="text-2xl font-bold text-gray-900 line-clamp-1">Edit: {initialPost.title}</h1>
                            </div>
